...
import StringBuilder from '@zxing/library/esm5/core/util/StringBuilder';
import DecodedInformation from '@zxing/library/esm5/core/oned/rss/expanded/decoders/DecodedInformation';
